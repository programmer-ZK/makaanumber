...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="https//ae.makanumber.com/vendor/core/core/base/css/email.css">
	</head>
	<body style="margin: 0;">
																								...
																								<tr>
																									<td style="padding:15px;border-collapse:collapse; height: 100px; line-height: 70px">
																										<a href="site_url" style="color: #fff; text-decoration: none !important;"
																											target="_blank">
																										<img title="Logo"
																											src="https://ae.makanumber.com/frontend-images/email-logo.png"
																											height="100"
																				...
																				<tr>
																					<td valign="middle" align="center"
																						...
																						<table align="right" border="0" cellpadding="0"
																							...
																							<tbody>
																								<tr>
																									<td style="font-size: 13px;line-height: 22px;color: #fff;padding: 15px;font-weight: normal;text-align: center;font-family: Tahoma, Helvetica, Arial, sans-serif;border-collapse: collapse;"><span style="display: inline-block; height: 100px; line-height: 100px;"><?php
																										// Change the line below to your timezone!
			date_default_timezone_set('Asia/Dubai');
$date = date('m/d/Y h:i:s a', time()); ?></span></td>
																								</tr>
																							</tbody>
																						</table>
																					</td>
						...
						<table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                            ...
                            <p style="position:relative">Want to know more about
                              <a href="www.makanumber.com" style="color: #fff; text-decoration: none !important;"
                                target="_blank"> 
                              <img title="Logo"
                              src="https://ae.makanumber.com/frontend-images/logo.png"
                              height="40"
