      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0 ">
          ...
          <li class="nav-item mt-2 ml-3 active" style="border:none !important;">
            <span class="mr-5">
              <img class="flag mr-1 active" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Flag_of_Pakistan.svg/320px-Flag_of_Pakistan.svg.png" />
	...
	<div class="container-fluid" style="background-color:#F6F6F6;">
		<div class="row  pt-5 pb-5">
			...
			<div class="footer_coloumn footer_coloumn_1 col-sm-3 ml-5 text-justify  ">
				...
				<p style="font-size:13px;" class="mt-3 foot-descip">Buying, Selling, Renting a property is an uphill
					...
					we can help you move forward, to experience the most unprecedented services along with enormous
		...
		<div class="row pl-5 pr-5 " style="background-color:#f9f9f9;">
			...
			<div class="col-sm-4 pt-2 pb-2 display" style="border-top:1px solid black; text-align:right !important; float:right;">
				<a style="text-decoration: underline; color:black;" href="/privacy-policy">Terms of use.</a> <a style="text-decoration: underline; color:black;" href="/privacy-policy"> Privacy Ploicy</a>
			</div>
